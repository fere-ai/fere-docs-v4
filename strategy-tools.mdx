...
description: "Sandbox SDK reference for Fere scheduled strategies: 69 fere_tools methods for market data, wallets, Polymarket, and Hyperliquid perps."
icon: "wrench"
keywords: ["fere_tools", "strategy sandbox", "scheduled strategies", "Polymarket tools", "Hyperliquid tools", "API reference"]
