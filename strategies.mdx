...
## Open from email or Telegram

Strategy update emails and Telegram messages open the same two places:

- **Main already funded** — you land on **Strategies** with that strategy selected, so you can configure and deploy.
- **Main empty** — you land on **Portfolio** first so you can deposit. The strategy stays attached to the link; after Main has a balance, continue into Strategies.

Email and Telegram use the same destinations. A $0 Main stays on Portfolio — Fere does not cover Deposit with a blocking modal.
