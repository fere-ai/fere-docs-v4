...
- **Recommended actions** — evidence-backed cards (now / soon / later) with direct imperative steps, category labels, and optional evidence details. **Accept** sends the action to Strategy chat; **Decline** removes it from your list. Generated from past trades, holdings, errors, your strategy text, and workspace scripts when present — separate from the narrative briefing.
