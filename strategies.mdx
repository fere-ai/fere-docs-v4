...
Also requires Hyperliquid setup. Add one or more perp markets from **Add Perp**; each gets its own card with its own on/off toggle. If you're running more than one market, select a card to see that market's activity in the sidebar.
