...
<Info>
  **Day and Swing Trading strategies** (Settings) automate Hyperliquid perp checks on a **dedicated strategy wallet**. They require [Hyperliquid setup and funding](/hyperliquid) before the first scheduled run. **Pause** stops new checks without sweeping funds; use wallet **Withdraw** (or delete the strategy) to move capital back to your main wallet. Still-funded closed strategies appear under **Archived strategies** until emptied — see [Wallet](/wallet#strategy-wallets).
</Info>
