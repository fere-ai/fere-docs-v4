...
| Tab | What you see |
| --- | --- |
| **Positions** | Open holdings for this strategy wallet (same rows as portfolio), including sell actions when available. Empty and load-error copy match the wallet overlay. |
