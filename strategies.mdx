...
- **Discover** — At the bottom of the page, pre-built templates let you launch a strategy in one click without typing anything.

## Discover

The **Discover** section inside the Strategies page has pre-built templates that get you running in one click. Pick one, fill in a few parameters, and Fere creates the full automated strategy for you.
